	    		...
	    		<div class="row">
					<div class="col-md-12">
						<div class="card-panel z-depth-2 hoverable">
					     	<h1 class="center-align">Depósitos Negados</h1>
...
$query = "SELECT * FROM vive_pen WHERE  status='negado' LIMIT $start_from, $per_page";
...
$query = "select * from vive_pen WHERE status='negado'";
$result = mysqli_query($con, $query);
...
echo "<li><a href='http://app.vivecolecciones.com.ve/depositos-negados/?page=1'>".'Primera página'."</a></li>";

for ($i=1; $i<=$total_pages; $i++) {
	if($ultimo==$i){$clase='active';}else{$clase='';}
echo "<li class='waves-effect ".$clase."'><a href='http://app.vivecolecciones.com.ve/depositos-negados/?page=".$i."'>".$i."</a></li>";
};
// Going to last page
echo "<li><a href='http://app.vivecolecciones.com.ve/depositos-negados/?page=".$total_pages."'>".'Última página'."</a></li>";
echo '</ul>';
