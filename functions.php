...
function prototipo_script_enqueue() {
    ...
    if ( is_page('dependencias') || is_page('escritorio') || is_page('estructura') || is_page('buscar-factura') || is_page('facturacion') || is_page('averias') || is_page('devoluciones') || is_page('cambios') || is_page('prueba') ){
