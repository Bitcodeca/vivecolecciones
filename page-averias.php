...
if ( is_user_logged_in() ) {
			...
			<div class="container-fluid margintop25 marginbot25">
				<div class="row"> 		
		    		<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
			        	...
			        	<?php
						$query3 = "SELECT DISTINCT usuario from vive_averia ORDER BY usuario ASC";
	...
	elseif ($user_logged['rol']=='Gerente') {
	    ...
	    if (mysqli_connect_errno()) {
	    	...
	    	?>
			<div class="container-fluid margintop25 marginbot25">	
		     	<h1 class="center-align">Averías</h1>
	    		<div class="row">
					<div class="col-md-12">
						<div class="card-panel z-depth-2 hoverable">

							<?php
								$stmt = $mysqli->prepare("SELECT id FROM vive_averia_con WHERE usuario=?");
						...
						<div class="card-panel z-depth-2 hoverable">
				        	...
				        	<div class="imprimir" id="Container">
								<table class="striped responsive-table">
							        ...
							        <tbody>
										<?php
											$stmt = $mysqli->prepare('SELECT fecha, art, can, obs, status, comentario FROM vive_averia WHERE usuario = ?');
											$stmt->bind_param('s', $gerente_logged);
											$stmt->execute();
