	...
	if($user_logged['rol']=='administrator'){
								...
								if(mysqli_num_rows($result) != 0) {
									while($row = mysqli_fetch_assoc($result)) {
										...
										if(mysqli_num_rows($result1) != 0) { ?>
											<ul class="collapsible imprimir" data-collapsible="accordion">
												<li>
													...
													<div class="collapsible-body paddingleft15 paddingright15">
														...
														<div class="row nobreak">
															<table class="responsive-table striped centered">
															        ...
															        <tbody>
																		...
																		$total_colecciones=0;
																		$costo_total=0;
																		$query2 = "SELECT * from vive_fac WHERE usuario='$usuario' AND cam='$cam'";
														...
														<div class="row center-align nobreak">
															<div class="col-xs-12 col-sm-4">
																<h2>Primer corte:</h2>
																<h3><b><?php echo $corte_q1; ?></b></h3>
															</div>
															<div class="col-xs-12 col-sm-4">
																<h2>Segundo corte:</h2>
																<h3><b><?php echo $corte_q2; ?></b></h3>
															</div>
															<div class="col-xs-12 col-sm-4">
																<h2>Tercer corte:</h2>
											        ...
											        <?php
											        	$total_a_depositar_quincenal=$total/3;
											        	...
											        	$depositado_total=0;
															...
															$porcentaje_total=$porcentaje_q1+$porcentaje_q2+$porcentaje_q3;
															...
															$ganancia_total=$ganancia_q1+$ganancia_q2+$ganancia_q3;
														...
														<div class="row nobreak">
															<table class="responsive-table striped centered">
															        ...
															        <tbody>
																          ...
																          <tr>
																	          <td>Cierre<br>(<?php echo $corte_q3; ?>)</td>
									...
									<form name="importa" method="post" >
										...
										<div class="row">
											<div class="col-xs-12 col-sm-4 col-sm-offset-4">
												<h1 class="center-align">Buscar Factura</h1>
	    ...
	    <?php } else {
	    		if(isset($_POST['btn'])){
    				...
    				if (in_array($usuario, $array_analista)) {
    					?>
				    	<div class="container-fluid margintop25 marginbot25">
							<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
								<div class="card-panel z-depth-2 hoverable">
